from spot_ledger import summarize_orders as spot_orders_summary
from instant_ledger import summarize_orders as instant_orders_summary
import json
...
#     pl_amount = sell_amount - (sell_qty * buy_avg)
#     pl_percent = (pl_amount / (sell_qty * buy_avg) * 100) if sell_qty > 0 else 0
...
#     # Calculate realized profit/loss for sold quantity
#     pl_amount = sell_amount - (sell_qty * buy_avg)
#     pl_percent = (pl_amount / (sell_qty * buy_avg) * 100) if sell_qty > 0 else 0
