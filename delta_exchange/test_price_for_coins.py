...
PRICE_ALERT = {
    "SOLUSD": {"low": 201.90, "high": 205},
    # "MUSD": {"low": 4000, "high": 4500},
...
def on_open(ws):
  ...
  subscribe(ws, "v2/ticker", ["SOLUSD", "MUSD"])
...
def on_message(ws, message):
    ...
    if "type" in data and data["type"] == "v2/ticker":
        ...
        current_price = round(float(data.get("mark_price")), 3)
...
def start_socket():
    """Persistent socket with auto-reconnect"""
    while True:
        try:
