...
#     print(obj)
#     print('------obj')
#     check = next((item for item in final_list if item["eid"] == obj['eid']), None)
#     if check is None:
#         final_list.append(obj)
#     else:
#         (item for item in final_list if item["eid"] == obj['eid'])
#     print('------check---')
#     print(check)
#     print('------check---')
# print()
...
#     temp_data["weekStartdate"] = sample_data["weekStartdate"]
#     temp_data["workHours"] = sample_data["workHours"]
#     final_dict[sample_data['eid']].append(temp_data)
#
